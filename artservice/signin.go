...
func SignIn(w http.ResponseWriter, r *http.Request) {
    ...
    if r.PostFormValue("userId") == "" || r.PostFormValue("email") == "" {
        OutputJson(w, -1, "userId or email is null", nil)
        return
    }
	...
	args = append(args, r.PostFormValue("email"))
	...
	OutputJson(w, 0, "SignIn ok", value)
}
